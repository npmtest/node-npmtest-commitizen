...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-commitizen/node_modules/commitizen/dist/commitizen/init.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-commitizen/node_modules/commitizen/dist/commitizen/init.js</span></h1>
    <h2>
        
        Statements: <span class="metric">37.04% <small>(20 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-commitizen/node_modules/commitizen/dist/commitizen/</a> &#187; init.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function init(sh, repoPath, adapterNpmName) {</span>
<span class="cstat-no" title="statement not covered" >  var _ref = arguments.length &gt; 3 &amp;&amp; arguments[3] !== undefined ? arguments[3] : defaultInitOptions,</span>
      _ref$save = _ref.save,
...
<span class="cstat-no" title="statement not covered" >  checkRequiredArguments(sh, repoPath, adapterNpmName);</span>
&nbsp;
  // Move to the correct directory so we can run commands
<span class="cstat-no" title="statement not covered" >  sh.cd(repoPath);</span>
&nbsp;
  // Load the current adapter config
<span class="cstat-no" title="statement not covered" >  var adapterConfig = loadAdapterConfig();</span>
&nbsp;
  // Get the npm string mappings based on the arguments provided
<span class="cstat-no" title="statement not covered" >  var stringMappings = getNpmInstallStringMappings(save, saveDev, saveExact, force);</span>
&nbsp;
  // Generate a string that represents the npm install command
<span class="cstat-no" title="statement not covered" >  var installAdapterCommand = generateNpmInstallAdapterCommand(stringMappings, adapterNpmName);</span>
&nbsp;
  // Check for previously installed adapters
<span class="cstat-no" title="statement not covered" >  if (adapterConfig &amp;&amp; adapterConfig.path &amp;&amp; adapterConfig.path.length &gt; 0) {</span>
&nbsp;
    // console.log(`
...
&nbsp;
      ...
      // `);
&nbsp;
<span class="cstat-no" title="statement not covered" >      throw 'A previous adapter is already configured. Use --force to override';</span>
    } else {
      // Override it
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        (0, _util.executeShellCommand)(sh, repoPath, installAdapterCommand);</span>
<span class="cstat-no" title="statement not covered" >        addPathToAdapterConfig(sh, CLI_PATH, repoPath, adapterNpmName);</span>
      } catch (e) {
 ...
 */
<span class="fstat-no" title="function not covered" >function checkRequiredArguments(sh, path, adapterNpmName) {</span>
...
<span class="cstat-no" title="statement not covered" >  if (!adapterNpmName) {</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function loadAdapterConfig() {</span>
<span class="cstat-no" title="statement not covered" >  var config = configLoader.load();</span>
