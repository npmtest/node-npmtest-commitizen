...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-commitizen/node_modules/commitizen/dist/configLoader/loader.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-commitizen/node_modules/commitizen/dist/configLoader/loader.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-commitizen/node_modules/commitizen/dist/configLoader/</a> &#187; loader.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        return (0, _configLoader.getContent)(config, directory);</span>
    }
&nbsp;
    content = (0, _configLoader.getContent)((0, _configLoader.findup)(configs, { nocase: true, cwd: directory }, function (configPath) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (_path2.default.basename(configPath) === 'package.json') {
...
<span class="cstat-no" title="statement not covered" >        return content;</span>
    ...
    /* istanbul ignore if */
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!(0, _util.isInTest)()) {
...
&nbsp;
                <span class="skip-if-branch" title="if path not taken" >I</span>if (content) {
