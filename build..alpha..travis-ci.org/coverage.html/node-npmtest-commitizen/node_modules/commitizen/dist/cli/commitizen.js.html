...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-commitizen/node_modules/commitizen/dist/cli/commitizen.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-commitizen/node_modules/commitizen/dist/cli/commitizen.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-commitizen/node_modules/commitizen/dist/cli/</a> &#187; commitizen.js</div>
</div>
<div class="body">
...
&nbsp;
function bootstrap() {
  var environment = arguments.length &gt; 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >arguments[0] !== undefined </span>? <span class="branch-0 cbranch-no" title="branch not covered" >arguments[0] </span>: {};
&nbsp;
&nbsp;
  // Get cli args
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (command === "init") {
<span class="cstat-no" title="statement not covered" >    var adapterNpmName = parsedArgs._[1];</span>
<span class="cstat-no" title="statement not covered" >    if (adapterNpmName) {</span>
<span class="cstat-no" title="statement not covered" >      console.log('Attempting to initialize using the npm package ' + adapterNpmName);</span>
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        (0, _commitizen.init)(sh, process.cwd(), adapterNpmName, parsedArgs);</span>
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        console.error('Error: ' + e);</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      console.error('Error: You must provide an adapter name as the second argument.');</span>
    }
  } else {
